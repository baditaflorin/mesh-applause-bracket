...
**Live → https://baditaflorin.github.io/mesh-applause-bracket/**

**Source → https://github.com/baditaflorin/mesh-applause-bracket**
...
git clone https://github.com/baditaflorin/mesh-applause-bracket
cd mesh-applause-bracket
npm install
npm run dev
```
...
- `mesh-applause-bracket:signalingUrl`
- `mesh-applause-bracket:turnTokenUrl`
- `mesh-applause-bracket:iceServers`
- `mesh-applause-bracket:room`
